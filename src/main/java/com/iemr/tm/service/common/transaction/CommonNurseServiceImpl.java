...
import com.iemr.tm.data.bmi.BmiCalculation;
import com.iemr.tm.data.doctor.BenReferDetails;
import com.iemr.tm.data.doctor.ProviderSpecificRequest;
...
import com.iemr.tm.repo.nurse.ncdscreening.PhysicalActivityTypeRepo;
...
public class CommonNurseServiceImpl implements CommonNurseService {
	...
	public Long savePrescriptionDetailsAndGetPrescriptionID(Long benRegID, Long benVisitID, Integer psmID,
			...
			String instruction, ArrayList<SCTDescription> provisionalDiagnosisList) {
	...
	public BenChildDevelopmentHistory getDevelopmentHistory(Long beneficiaryRegID, Long visitCode) {
		ArrayList<Object[]> benChildDevelopmentHistory = benChildDevelopmentHistoryRepo
				.getBenDevelopmentDetails(beneficiaryRegID, visitCode);
	...
	public PerinatalHistory getPerinatalHistory(Long beneficiaryRegID, Long visitCode) {
	...
	public ChildFeedingDetails getFeedingHistory(Long beneficiaryRegID, Long visitCode) {
